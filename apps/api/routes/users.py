...
from deps import _ensure_owner, _load_user_with_ownership, get_or_create_user, sync_timezone_from_header
from exceptions import AIGenerationError
from models import (
    DailyTask, Goal, Reward, ShopReward, StarLog,
...
async def get_star_log(
    ...
    return await get_or_create_star_log(
        user_id=user_id,
